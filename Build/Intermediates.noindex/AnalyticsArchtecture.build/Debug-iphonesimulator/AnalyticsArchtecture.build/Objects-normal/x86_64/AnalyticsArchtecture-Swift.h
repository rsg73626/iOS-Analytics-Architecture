...
#ifndef ANALYTICSARCHTECTURE_SWIFT_H
#define ANALYTICSARCHTECTURE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AnalyticsArchtecture",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC20AnalyticsArchtecture11AppDelegate")
...
SWIFT_CLASS("_TtC20AnalyticsArchtecture19LoginViewController")
@interface LoginViewController : UIViewController
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
- (void)viewDidAppear:(BOOL)animated;
- (IBAction)didPressEnter;
...
SWIFT_CLASS("_TtC20AnalyticsArchtecture13SceneDelegate")
